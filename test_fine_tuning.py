...
train_image_dir = r'C:\Users\mlworker\Documents\Tensorflow\models\research\object_detection\test_images\ducky\train'
train_images_np = []
for i in range(1, 6):
...
checkpoint_path = os.path.join(MODELS_DIR, os.path.join(MODEL_NAME, 'checkpoint/', 'ckpt-0'))
...
test_image_dir = r'C:\Users\mlworker\Documents\Tensorflow\models/research/object_detection/test_images/ducky/test/'
test_images_np = []
for i in range(1, 50):
